...
@font size=16
@locate x=290 y=550
[link storage="CG.ks" target=*cg_p01]［前へ］[endlink][link storage="first_shiki.ks" target=*menu]［タイトルへ戻る］[endlink]
;-----------------------------------------

@locate x=12 y=0
@button graphic=vis_s23 target=*cg01

@locate x=206 y=0
@button graphic=vis_s25 target=*cg02

@locate x=400 y=0
@button graphic=vis_s26 target=*cg03

@locate x=594 y=0
@button graphic=vis_s27 target=*cg04

;-----------------------------------------

@locate x=12 y=140
@button graphic=vis_s29 target=*cg05

@locate x=206 y=140
@button graphic=vis_s30 target=*cg06
