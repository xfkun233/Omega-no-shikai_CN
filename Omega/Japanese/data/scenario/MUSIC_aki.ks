...
@font size=16
@locate x=290 y=550
[link storage="first_aki.ks" target=*menu]［タイトルへ戻る］[endlink]
;-----------------------------------------
@font size=17
@locate x=550 y=0
[link target=*op]◆『砂の城』[endlink][r]
@locate x=550
@font size=14
　※ショートバージョン[r]
@locate x=550
...
@locate x=550
[link target=*m16b]◆Ｍ１６b[endlink][r]
@locate x=550
@font size=17
...
@s
*op
@playbgm storage=sunasiro_short.ogg
