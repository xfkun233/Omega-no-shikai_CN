...
「Omega の視界」是一款日式视觉小说游戏，本项目包含了中文本地化版本，~~目前采用 AI 翻译结合人工校对的方式进行翻译~~，因为骗来了一个翻译，所以该项目已完全实现人工翻译。
